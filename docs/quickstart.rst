...
Having installed colifrapy, initialize a new project with the Scaffolder by typing into your
console::
...
Note that if you just want to use colifrapy features but don't want to be tied to its architecture,
...
Colifrapy offers to externalize your strings in order to enable you to quickly modify them if needed, or even translate them easily and quickly.
